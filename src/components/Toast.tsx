  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-2 pointer-events-none max-w-sm w-full">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className="pointer-events-auto flex items-start gap-3 bg-white text-gray-900 px-4 py-3.5 rounded-xl border border-gray-200/80 shadow-lg shadow-gray-950/5 animate-in fade-in slide-in-from-bottom-3 duration-200 transition-all"
        >
